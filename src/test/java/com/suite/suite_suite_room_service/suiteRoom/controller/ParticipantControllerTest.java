...
import com.suite.suite_suite_room_service.suiteRoom.mockEntity.MockCheckInDto;
...
class ParticipantControllerTest {
    ...
    public void checkInSuiteRoom() throws Exception {
        ...
        Map<String, MockCheckInDto> messageCard = new HashMap<String, MockCheckInDto>();
        MockCheckInDto check = new MockCheckInDto(1L, 1L);
        messageCard.put("checkInInfo", check);
